...
DirectResource::DirectResource(D3D_FEATURE_LEVEL fl) :
    m_window(nullptr),
    m_outputHeight(600),
    m_outputWidth(800),
...
void DirectResource::OnDeviceLost()
{
...
void DirectResource::CreateResources()
{
...
void DirectResource::SetWindowSize(int width, int heigth)
{
    m_outputWidth = width;
    m_outputHeight = heigth;
}

void DirectResource::SetWindow(IUnknown* window)
{
    m_window = window;
}

void DirectResource::SetWindowRotation(DXGI_MODE_ROTATION rot)
{
    m_outputRotation = rot;
}

void DirectResource::OnWindowSizeChanged(int width, int height, DXGI_MODE_ROTATION rotation)
{
    m_outputWidth = width;
...
void DirectResource::SetViewPort()
{
...
void DirectResource::CreateDevice()
{
...
void DirectResource::ValidateDevice()
{
